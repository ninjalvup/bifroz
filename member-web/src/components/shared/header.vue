<template>
  <div id="header">
    <!-- NavBar -->
    <header class="navbar-fixed" style="background-color: #2a2a2a">
      <div class="header-top-bg col-md-11 col-lg-6 ml-auto mr-auto">
        <nav
          class="
            nav
        ...
        >
        <router-link to="/profile" class="text-gold-dg header-nav-icon text-center"
        style="max-width: 35px">

            <div style="position: relative; left: 1rem">
              <img
                src="assets/images/custom/profile.png"
            ...
            <div class="text-nowrap" style="width: 4rem">
              ...
              <p
                style="width: 4rem; font-size: 10px"
          ...
          <router-link to="/casino"
            class="header-nav-logo mb-1 mx-auto"
          ...
          >
            <img
              ...
              alt="Logo_big"
              style="width: revert; height: 2.7rem; object-fit: cover"
            />
          </router-link>

          <div
            class="mr-1 sidebar-right"
            style="max-width: 40px; cursor: pointer; padding-top: 0.5rem"
          >
            <div class="hamburger-menu">
              <label class="menu__btn" for="menu__toggle">
                <img
                  src="assets/images/custom/navicon.png"
                  class="menu-collape ml-auto"
                  alt="menu_collape"
                  style="margin-left: -30px !important; width: 180%"
                />
              </label>
              <input
                id="menu__toggle"
              ...
              <ul class="menu__box2" @click="clear()"></ul>
              <ul class="menu__box">
                ...
                <img
                  ...
                  class="menu-collape ml-auto"
                  alt="menu_collape"
                  style="margin-left: 115px !important;width: 180%;margin-top: -15px;"
                />
              </label>


                <router-link to="/sharedLink" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                        src="assets/images/custom/icon-link.png"
                        class="img-fluid"
                        alt=""
                        srcset=""
                        width="25"
                      />
                      <span class="ml-1"> ลิงค์รับทรัพย์ </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/casino" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      ...
                      src="assets/images/icon-left/3.png"
                      alt=""
                        srcset=""
                        width="30"
                    />
                      <span class="ml-1"> คาสิโน </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/baccarat" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                      class="menu-icon img-fluid"
                      src="assets/images/icon-left/4.png"
                      alt=""
                        srcset=""
                        width="30"
                    />
                      <span class="ml-1"> ไพ่ </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/home" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                      class="menu-icon img-fluid"
                      src="assets/images/icon-left/1.png"
                      alt=""
                        srcset=""
                        width="30"
                    />
                      <span class="ml-1"> กำลังฮิต </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/slot" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                      class="menu-icon img-fluid"
                      src="assets/images/icon-left/2.png"
                      alt=""
                        srcset=""
                        width="30"
                    />
                      <span class="ml-1"> สล็อต </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/profile" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                        src="assets/images/custom/icon-accountuser.png"
                        class="img-fluid"
                        alt=""
                        srcset=""
                        width="30"
                      />
                      <span class="ml-1"> บัญชีผู้ใช้ </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <router-link to="/changPassword" class="nav-link">
                  <li @click="clear()">
                    <a class="menu__item" href="#">
                      <img
                        src="assets/images/custom/icon-changepassword.png"
                        class="img-fluid"
                        alt=""
                        srcset=""
                        width="30"
                      />
                      <span class="ml-1"> เปลี่ยนรหัสผ่าน </span>
                    </a>
                  </li>
                  <div
                    class="text-center"
                ...
                <li @click="logout" class="nav-link">
                  ...
                  >
                    <img
                      src="assets/images/custom/icon-logout.png"
                      class="img-fluid"
                      alt=""
                      srcset=""
                      width="30"
...
body {
  ...
  background: radial-gradient(ellipse at center, #fcfcfc 0%, #f2f2f2 100%);
  font-weight: 400;
...
.project-list .media .overlay {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(46, 199, 203, 0.8) 0%,
    rgba(108, 139, 239, 0.8) 100%
  );
...
.ribbon.success .background-image:before {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(45, 193, 201, 0.2) 0%,
    rgba(33, 148, 193, 0.9) 30%,
    #252d47 100%
  );
  background: -webkit-linear-gradient(
    left,
...
.ribbon.danger .background-image:before {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(228, 124, 100, 0.2) 0%,
    rgba(227, 100, 129, 0.9) 30%,
    #252d47 100%
  );
  background: -webkit-linear-gradient(
    left,
...
.ribbon.warning .background-image:before {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(255, 186, 0, 0.2) 0%,
    rgba(252, 146, 68, 0.9) 30%,
    #252d47 100%
  );
  background: -webkit-linear-gradient(
    left,
...
.ribbon.primary .background-image:before {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(122, 121, 254, 0.2) 0%,
    rgba(167, 88, 245, 0.9) 30%,
    #252d47 100%
  );
  background: -webkit-linear-gradient(
    left,
...
.context-menu-list
  .context-menu-item.context-menu-hover.context-menu-icon:before {
  color: #ffffff;
}
...
.bg-aff-new-1 {
  /* background: url('../img/link_1/share.png'); */
}
/*==============================================*/
/*=============== nav-tabs styles===============*/
/*==============================================*/
...
.fc-unthemed .fc-list-heading td {
  ...
  background: -moz-linear-gradient(
    left,
    rgba(46, 199, 203, 0.4) 0%,
    rgba(108, 139, 239, 0.4) 100%
  );
  background: -webkit-linear-gradient(
    left,
    rgba(46, 199, 203, 0.4) 0%,
...
.container_wizard.wizard-bordered
  .stepwizard
  .stepwizard-step
  a
  span.btn-round {
...
.can-toggle.demo-rebrand-2.small
  input[type="checkbox"]:focus
  ~ label
  .can-toggle__switch:after,
.can-toggle.demo-rebrand-2.small
...
body.rtl-read .input-group,
body.rtl-read .nav,
body.rtl-read .progress,
body.rtl-read header .navbar .navbar-brand,
body.rtl-read .list-group,
body.rtl-read .card-block,
body.rtl-read .navbar-nav,
body.rtl-read header .navbar,
body.rtl-read .media,
body.rtl-read .row {
...
.jstree-default .jstree-icon {
  /* background-image: url("../vendor/jstree/dist/themes/default/32px.png"); */
}
...
@-webkit-keyframes load5 {
  0%,
  100% {
    box-shadow: 0em -2.6em 0em 0em black, 1.8em -1.8em 0 0em rgba(0, 0, 0, 0.2),
  ...
  12.5% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.7), 1.8em -1.8em 0 0em black,
      2.5em 0em 0 0em rgba(0, 0, 0, 0.2), 1.75em 1.75em 0 0em rgba(0, 0, 0, 0.2),
      0em 2.5em 0 0em rgba(0, 0, 0, 0.2), -1.8em 1.8em 0 0em rgba(0, 0, 0, 0.2),
  ...
  25% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.5),
      1.8em -1.8em 0 0em rgba(0, 0, 0, 0.7), 2.5em 0em 0 0em black,
  ...
  37.5% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.2),
      ...
      1.75em 1.75em 0 0em black, 0em 2.5em 0 0em rgba(0, 0, 0, 0.2),
      -1.8em 1.8em 0 0em rgba(0, 0, 0, 0.2), -2.6em 0em 0 0em rgba(0, 0, 0, 0.2),
      -1.8em -1.8em 0 0em rgba(0, 0, 0, 0.2);
  }
  50% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.2),
      ...
      1.75em 1.75em 0 0em rgba(0, 0, 0, 0.7), 0em 2.5em 0 0em black,
      -1.8em 1.8em 0 0em rgba(0, 0, 0, 0.2), -2.6em 0em 0 0em rgba(0, 0, 0, 0.2),
      -1.8em -1.8em 0 0em rgba(0, 0, 0, 0.2);
  }
  62.5% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.2),
      ...
      -1.8em 1.8em 0 0em black, -2.6em 0em 0 0em rgba(0, 0, 0, 0.2),
      -1.8em -1.8em 0 0em rgba(0, 0, 0, 0.2);
  }
  75% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.2),
      ...
      -1.8em 1.8em 0 0em rgba(0, 0, 0, 0.7), -2.6em 0em 0 0em black,
      -1.8em -1.8em 0 0em rgba(0, 0, 0, 0.2);
  }
  87.5% {
    box-shadow: 0em -2.6em 0em 0em rgba(0, 0, 0, 0.2),
...
.text-gold-dg {
  color: #f7ddaf !important;
}

.border-dg {
  border: 1px solid #f7ddaf;
}
...
.btn-blue-iamg {
  background: rgba(0, 206, 163, 1);
  background: -moz-linear-gradient(
    top,
    rgba(0, 206, 163, 1) 0%,
    rgba(0, 125, 217, 1) 100%
  );
  background: -webkit-gradient(
    left top,
    left bottom,
    color-stop(0%, rgba(0, 206, 163, 1)),
    color-stop(100%, rgba(0, 125, 217, 1))
  );
  background: -webkit-linear-gradient(
    top,
    rgba(0, 206, 163, 1) 0%,
  ...
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#00cea3', endColorstr='#007dd9', GradientType=0 );
...
.btn-black-iamg:hover,
.btn-black-iamg:focus,
.btn-black-iamg:active,
.btn-black-iamg.active {
  background: #242629;
...
.bg-aff-new {
  /* background: url(../../../assets/adminux/img/link_1/iconlink.png) left center no-repeat; */
...
footer ul.nav-bottom-bar li a img.responsive-img-new {
  max-width: unset;
  height: unset;
  position: absolute;
  right: 0px;

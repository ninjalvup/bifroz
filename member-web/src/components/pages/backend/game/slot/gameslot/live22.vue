      ...
      <div class="col-md-9">
        <div class="card mt-4 shadow">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Live22</li>
          </ol>
          <div class="card-body">
...
export default {
  ...
  methods: {
    ...
    async playgame(gameId) {
      this.gameId = gameId;
      try {
        const resp = await gameService.playLive22(gameId);

        if (resp.message === undefined) {
          this.$toast.error("ไม่สามารถใช้งานได้ในขณะนี้", {
            position: "top-right",
            timeout: 1500,
          });
        } else {

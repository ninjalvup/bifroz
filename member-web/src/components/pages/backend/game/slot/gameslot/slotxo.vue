      ...
      <div class="col-md-9">
        <div class="card mt-4 shadow">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">SlotXO</li>
          </ol>
          <div class="card-body">
            <div id="slot" class="row justify-content-center">
              ...
              >
                <div>
                  <div>
                    <img
                      @click="playgame(data.gameCode)"
                      class="ampPoker mt-2"
                      :src="
                        'https://s3-ap-southeast-1.amazonaws.com/cdn.ambbet.com/' +
                        data.imgUrl
                      "
                      alt=""
                    />
  ...
  methods: {
    ...
    async playgame(gameCode) {
      ...
      try {
        ...
        const resp = await gameService.playSlotxo(gameForm);
        if (resp.code == 0) {
          window.open("", "popup", "fullscreen").location.href = resp.result;
        }
      } catch (error) {

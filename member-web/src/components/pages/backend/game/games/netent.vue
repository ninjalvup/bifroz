        ...
        <div class="row mx-0 category-container">
          ...
          >
            ...
            <div
                ...
                class="game_card_container slide" style="width: 50%"
              >
                <a
                ...
                <div class="game_card">
                  ...
                  <img
                    :src="'https://img.betflix777.com' + gamelists.img"
                    class="img-fluid logoGame w-100 rounded"
                    alt="Responsive image"
                  />
                  <small class="wrapper-gametxtName d-block text-center">{{
                    gamelists.name
                  }}</small>
                  </div>
                </a>
...
export default {
  ...
  mounted() {
    ...
    axios.get("https://lion-gp.com/list.php?game=netent").then((resp) => {

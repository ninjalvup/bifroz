  ...
  <div id="User">
    <div class="page-inner">
      <div class="page-header">
        <h4 class="page-title">
          <i class="fas fa-user"></i> รายการถอนที่ไม่ได้อนุมัติ
        </h4>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col">
                  <h3 class="card-title">ข้อมูลที่ไม่ได้อนุมัติ: การถอน</h3>
                </div>
              </div>
            </div>
  <div class="row">
              ...
              <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover">
                  ...
                  <tbody style="text-align:center">
                    <tr v-for="data in withdrawpending" v-bind:key="data.id">
                      <td>
                        <div class="avatar mt-3">
                          <img
                            :src="require(`../../../assets/bank_icon/${data.member_account_banks[0].bank_name.toLowerCase()}.png`)"
                            class="icon"
                            width="40"
                        ...
                        <div><b>
                            ...
                            ></b
                          ></div>
                        <div>{{data.member_account_banks[0].bank_account_name}}</div>
                      </td>
                      <td> <b>
                          <a
                            href="#/withdrawdisapprove"
                      ...
                      <td>
                        ...
                        <div v-if="data.transaction_status =='2'">
                          <span class="badge badge-danger">ไม่ได้อนุมัติ</span>
                        </div>
                      </td>
...
export default {
 ...
 async mounted() {
  ...
  await  axios({
      method: "get",
      url: `${baseURL}/member_transaction/withdraw-dis-approve-list/?start_date=${start_date}&end_date=${end_date}&username=`,
      headers: {
...
moment() {
    ...
    getDataParam() {
      ...
      axios({
        method: "get",
        url: `${baseURL}/member_transaction/withdraw-dis-approve-list/?start_date=${start_date}&end_date=${end_date}&username=${username}`,
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + localStorage.getItem("access_token"),
        },
